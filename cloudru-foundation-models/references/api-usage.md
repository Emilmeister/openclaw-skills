...
- When you wire the model into OpenClaw via a custom provider, the full model ref becomes `provider/<model-id>`, for example `cloudru-foundation/GigaChat/GigaChat-2-Max`.
